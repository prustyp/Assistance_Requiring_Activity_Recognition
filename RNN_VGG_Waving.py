...
def main():
    ...
    list_of_folder_with_extracted_feature.append("/home/pprusty05/Deep_learning/data/Training/extracted_features_vgg19/waving")
    ...
    test_eval_dict['description_of_model'] = 'Waving -- VGG '
